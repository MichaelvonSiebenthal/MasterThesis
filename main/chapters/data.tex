  ...
  of a type such that realistic probabilities can be assigned. As an example, 
  ...
  difficult to use for the MAG model. For that reason, age is binned into 4 
  categories with 0 if age $<$ 26, 1 if 26 $\leqslant$ age $<$ 39, 2 if 39 
  ...
  variable age. The transformed variable now contains 4 categories and now
