  ...
  only considered to the extent that the attributes create structures 
  ...
  the more parsimonious model with 2 dimensions is preferred. As a final test, 
  ...
  mentioned in section \ref{section:GNN_theory}, the models GCN 
  \citep{kipf2016semi} and GraphSage \citep{hamilton2017inductive} are used 
  for classifying the satisfaction of the US airline passengers. The model 
  specifications and results are presented in the following sections for both 
  methods.
  ...
  For GraphSage the exact same data input is used as for the GCN. The 
